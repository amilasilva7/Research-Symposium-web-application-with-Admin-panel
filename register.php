...
<div class="container" style="padding-top: 95px;">
  ...
  <div class="row" style="padding-top: 0px">
    ...
    <div class="col-sm-12 shadow-lg p-5 mb-5 bg-white rounded" style="border: ridge; padding-top:0px;padding-bottom: 1px;border-radius:1px;color: black;">
      ...
      <div class="row" style="padding-top: 0px;">
        ...
        <div class="col-sm-12 form-inline " style="border-bottom: ridge;border-top: ridge;background-color: #1E3566;padding-top: 5px;border-radius:1px;border-radius: 5px">
          ...
          <div class="col-sm-8 text-center" style="padding-bottom: 0px;">
            <h2 class="display-4" style="color: white">REGISTRATION FORM</h2>
          </div>
...
<!-------------------------------------------------FORM---------------------------------------------->
      <div class="col-sm-12" style="padding-top: 10px">
        ...
        <form class="needs-validation" method="post" action="register.php" enctype="multipart/form-data" novalidate >
    ...
    <div class="col-sm-12" style="height: 20px;background-color:#75D07B; padding-top:20px"></div>
